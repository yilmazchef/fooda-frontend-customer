...
@Tag("vaadin-decimal-field")
@HtmlImport("frontend://bower_components/vaadin-text-field/src/vaadin-decimal-field.html")
@JsModule("@vaadin/vaadin-text-field/src/vaadin-decimal-field.js")
public class BigDecimalField extends AbstractNumberField<BigDecimalField, BigDecimal> {
    
    private static final SerializableFunction<String, BigDecimal> PARSER = valueFormClient -> {
        if (valueFormClient == null || valueFormClient.isEmpty()) {
            return null;
        }
        try {
            return new BigDecimal(valueFormClient);
    ...
    public BigDecimalField() {
        ...
        //      super(PARSER, FORMATTER, new BigDecimal(String.valueOf(Integer.MIN_VALUE)), new BigDecimal(String.valueOf(Integer.MAX_VALUE)));
    }
